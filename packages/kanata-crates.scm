...
(define-public rust-kanata-tcp-protocol-0.190
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "04cw6jkxws04nkh7cjhr1ha0lg7yisqrp9282pzdcvp0z2vxnb7s"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
...
(define-public rust-kanata-parser-0.190
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0g5mzskdaxkpvfix88c6ikspnjjihm43a8cqhq0zspi8bz8j8h42"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:cargo-inputs (("rust-anyhow" ,rust-anyhow-1)
                       ...
                       ("rust-kanata-keyberon" ,rust-kanata-keyberon-0.190)
...
(define-public rust-kanata-keyberon-0.190
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "07fywn8g6gjcf0fw1r2g0agp42q6npdmnryls9r9w92r2mjg0pmw"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "09sjqy9555g1nr22xfh07y2mhcnzh69vjydrbvz6y8xgw3w37xam"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0iqizzch75j3qrx76bx9qx8cfnp20pdl93snqkk7lp8cm9l8rqbw"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs (("rust-anyhow" ,rust-anyhow-1)
                       ...
                       ("rust-kanata-keyberon" ,rust-kanata-keyberon-0.190)
                       ("rust-kanata-parser" ,rust-kanata-parser-0.190)
                       ("rust-kanata-tcp-protocol" ,rust-kanata-tcp-protocol-0.190)
...
(define-public kanata
  (package
    (inherit rust-kanata-1)
    (name "kanata")
    (inputs (modify-inputs (package-inputs rust-kanata-1)
              (prepend libevdev)))
    (synopsis "Cross-platform keyboard remapper")
    (description
     "Kanata brings QMK-style multi-layer remapping, tap-hold keys, Unicode \
macros and more to any keyboard on Linux, macOS and Windows.")))

(define-public kanata-cmd
  (package
    (inherit kanata)
    (name "kanata-cmd")
    (arguments
     (substitute-keyword-arguments (package-arguments kanata)
       ((#:cargo-build-flags flags)
        #~(append '#$flags '("--features" "cmd")))))
    (synopsis "Kanata built with command-action support")))
